...
impl<H: CefEventHandler> ImplDisplayHandler for DisplayHandlerImpl<H> {
	fn on_cursor_change(&self, _browser: Option<&mut cef::Browser>, _cursor: *mut u8, cursor_type: cef::CursorType, _custom_cursor_info: Option<&cef::CursorInfo>) -> ::std::os::raw::c_int {
